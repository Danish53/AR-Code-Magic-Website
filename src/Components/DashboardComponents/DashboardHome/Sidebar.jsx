    ...
    <div className="d-flex flex-column p-3 bg-white shadow" style={{ height: "100%" }}>
      ...
      <ul className="nav nav-pills flex-column dashboardsb-links gap-2">
        <li>
          <Link
            to="/user"
            className={`nav-link navlink-custom sidebar-link d-flex align-items-center ${
              isActive("/user") && !location.pathname.includes("/user/") ? "active" : ""
            }`}
          >
        ...
        <li>
          <Link
            ...
            className={`nav-link navlink-custom sidebar-link d-flex align-items-center ${
              isActive("/user/custom-pages") ? "active" : ""
            }`}
          >
        ...
        <li>
          <Link
            ...
            className={`nav-link navlink-custom sidebar-link d-flex align-items-center ${
              isActive("/user/ar-code-studio") ? "active" : ""
            }`}
          >
      ...
      <div className="membership-section mt-4">
        ...
        <Link to="/pricing" className="standard-link ms-2">
        {/* <Link to="/standard" className="standard-link ms-2"> */}
          STANDARD
        </Link>
      </div>
      ...
      <div className="stats-section mt-3">
        <p className="mb-1">
          <strong>1/100</strong> AR Code Magics
        </p>
        <p className="mb-1">
          <strong>3/10000</strong> Monthly scans
        </p>
        <p className="mb-1">
          <strong>0/100</strong> Custom Pages
        </p>
        <p className="mb-0">
          <strong>1/100</strong> Tracking
        </p>
      </div>
    </div>
  );
