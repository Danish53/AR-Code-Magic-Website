...
//     Explore how to bring your words to life with AR Code Magic's 3D Text feature in this brief FAQ.
//   </p>
...
//           <strong>What are the size limitations for uploading 3D files to AR Code Magic?</strong>
//         </h4>
...
//       <div className="p-4 shadow-sm rounded bg-light">
//         <h4 className="text-primary-color text-center mb-3">
//           <strong>How can I optimize my 3D models for AR display on AR Code Magic?</strong>
//         </h4>
//         <p className="text-muted">
...
function ServicesFAQ() {
  ...
  const questions = [
    {
      question: "What are the advantages of AR Logo in branding? ",
      answer:
        "This brings up something completely fresh, making your audience feel your brand is alive, not static; more and deeper connection by way of AR. ",
    },
    {
      question: "How do I make an AR Logo on AR Code Magic? ",
      answer:
        "Simply upload your SVG logo file to AR Code Magic, and our platform will take care of the rest, converting it into a 3D AR experience anchored by an AR QR Code. ",
    },
    {
      question: "Where can I use my AR Logo?",
      answer:
        "You can include your AR Logo on all marketing material, be it digital or print, for a memorable brand experience through a simple QR Code scan on any mobile device without requiring any app.  ",
    },
    {
      question: "Do I have the right to cancel my AR Code Magic subscription at will?",
      answer:
        "Yes, you may cancel at any time. We will process your cancellation prior to the next billing cycle so that you can continue to use premium features until your current subscription ends. ",
    },
  ];
  ...
  return (
    <div className="bg-primary-light">
      <div className="container py-5">
        ...
        This short FAQ tells you more about building a 3D Logo using the AR Logo feature on AR Code Magic. 
        </p>
