      ...
      <div className="container my-5">
        ...
        <div className="text-center mb-4">
          <p className="font-weight-bold text-white" style={{ fontSize: "28px" }}>
            Enhance your brand's logo with AR Code Magic. Experience the innovative future of branding with our AR Logo
            feature.
          </p>
        </div>
        ...
        <div className="row promo d-flex align-items-center justify-content-center gap-5">
          ...
          <div className="col-md-5 text-center z-1">
            ...
            <p className="maindescription text-center web-font-size">
              AR Logo is a unique feature that AR Code Magic provides by utilizing Augmented Reality technology.
              Nowadays, you may use its AR QR Code to turn your ordinary logo into a dynamic 3D object that exists
