...
function ServicesFAQ() {
  ...
  const questions = [
    {
      question: "What is the AR Text? ",
      answer:
        "AR Text transforms your texts into 3D models. Type your message and watch your text transform into a 3D model in the AR on any device using their AR QR Code. ",
    },
    {
      question: "Can I change the font style and color of my AR Text?",
      answer:
        "With many fonts and colors available, you can make your 3D text fit your message or brand. This can be possible on our iOS app and web interface as well. ",
    },
    {
      question: "How can I share my 3D text AR experiences? ",
      answer:
        "You can share your AR creations by generating AR Codes with our app or web interface. Those codes may be shared and scanned on any smartphone or AR headset. This way, users are able to see your 3D text in AR without needing additional apps.  ",
    },
    {
      question: "Is there any Free Trial provided for making AR Texts? ",
      answer:
        "Yes, AR Code Magic offers a free trial to first-time users. Simply, sign up on our website to use the AR Text tool and start creating your AR experiences without any cost. ",
    },
  ];
    ...
    <div className="bg-primary-light">
      <div className="container py-5">
        ...
        <p className="text-center text-white web-font-size mb-5">
          Learn how to breathe your words into life with the 3D Text feature of AR Code Magic in this concise
          FAQ.
        </p>
