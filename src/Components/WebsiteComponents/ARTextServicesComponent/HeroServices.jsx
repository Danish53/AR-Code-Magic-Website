      ...
      <div className="container my-5">
        ...
        <div className="text-center mb-4">
          <p className="font-weight-bold text-white" style={{ fontSize: "28px" }}>
            AR Text is introducing new ways to bring your text to life.
          </p>
        </div>
        ...
        <div className="row promo d-flex align-items-center justify-content-center gap-5">
          ...
          <div className="col-md-5 text-center z-1">
            ...
            <br />
            <h2 className="font-weight-bold fw-bold">Text to AR.</h2>
            <p className="maindescription text-center web-font-size">
              AR text tool converts your text into 3D AR experiences within a few clicks. This option is also available on
              other platforms like the AR Text iOS app.
            </p>
