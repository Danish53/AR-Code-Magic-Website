      ...
      <div className="container my-5">
        ...
        <div className="text-center mb-4">
          <p className="font-weight-bold text-white" style={{ fontSize: "28px" }}>
            Convert your 3D models into interactive AR experiences with our 3D File Upload feature.
          </p>
        </div>
        ...
        <div className="row promo d-flex align-items-center justify-content-center gap-5">
          ...
          <div className="col-md-5 text-center z-1">
            ...
            <p className="maindescription text-center web-font-size">
              AR Code Magic will be changing the way the content of 3D experiences is shared and experienced due to the
              simplification involved in converting 3D models into AR renders. Enjoy immersing audiences with
              experience by scanning a simple AR QR code.
