    ...
    <section className=" heroServices">
      ...
      <div className="container my-5">
        ...
        <div className="text-center mb-4">
          ...
          Discover AR Portals, where 360-degree photos blend with reality through AR QR Codes.
          </p>
        </div>
        ...
        <div className="row promo d-flex align-items-center justify-content-center gap-5">
          ...
          <div className="col-md-5 text-center z-1">
            ...
            <p className="maindescription text-center web-font-size">
              Use AR Portals to enhance immersive marketing, narrative, or educational experiences by giving users
              access to 360-degree AR photographs on smartphones and AR/VR headsets.
            </p>
