...
function ServicesFAQ() {
  ...
  const questions = [
    {
      question: "How can I get insights from AI Codes? ",
      answer:
        "Take a photo with AI Code on any smartphone to get instant AI feedback and suggestions, no app is required.",
    },
    {
      question: "How do I create my AI Code?",
      answer:
        "Input your prompts or create them with our Prompt Generator, and your AI Code will be ready to deliver AI insights in minutes. Share your AI Code for compelling, intelligent experiences. ",
    },
    {
      question: "What Do I Need to Have on My Images for My AI Codes?",
      answer:
        "Have crisp images so that the AI can have a better understanding, hence delivering more accurate and relevant insights from the AI. ",
    },
    {
      question: "Can I cancel my subscription at any time? ",
      answer:
        "Yes, you can cancel your subscription anytime and get to enjoy premium features till the end of your current term. ",
    },
  ];
    ...
    <div className="bg-primary-light">
      <div className="container py-5">
        ...
        <p className="text-center text-white web-font-size mb-5">
          AI Codes transform how we interact by bringing us a personalized AI assistant, with no need for more
          apps. Here are answers to your common questions.
        </p>
