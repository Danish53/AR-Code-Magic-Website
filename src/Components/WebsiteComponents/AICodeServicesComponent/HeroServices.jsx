      ...
      <div className="container my-5">
        ...
        <div className="text-center mb-4">
          <p className="font-weight-bold text-white" style={{ fontSize: "28px" }}>
            Explore our AI Code feature, combining the power of Artificial Intelligence with Augmented Reality
            through an AI Assistant QR Code.
          </p>
        </div>
        ...
        <div className="row promo d-flex align-items-center justify-content-center gap-5">
          ...
          <div className="col-md-5 text-center z-1">
            <h1
              ...
              style={{ fontSize: "32px" }}>
              Artificial Intelligence QR Code
            </h1>
            <br />
            <div>
            ...
            <p className="maindescription text-center web-font-size">
              By utilizing AI in augmented reality, AI Code transforms how users engage with your materials, products,
              and settings by providing them with one-of-a-kind, AI-powered experiences straight on their
              smartphones.
            </p>
