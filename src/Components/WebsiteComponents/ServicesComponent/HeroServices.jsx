      ...
      <div className="container my-5">
        ...
        <div className="text-center mb-4">
          <p className="font-weight-bold text-white"  style={{ fontSize: "28px" }}>
            Transform your 3D models into Augmented Reality experiences with our 3D File Upload feature.
          </p>
        </div>
        ...
        <div className="row promo d-flex align-items-center justify-content-center gap-5">
          ...
          <div className="col-md-5 text-center z-1">
            ...
            AR Code is changing how 3D content is shared and experienced
             by simplifying the conversion of 3D models into AR renders. 
             Easily engage audiences with immersive AR experiences accessible
              through a simple AR QR Code scan.
            </p>

            <Link 
            to="/user/register" 
            className="btn btn-success btn-custom btn-lg mt-3 rounded-pill">
            Create an AR Magic Code
          </Link>
          </div>
        </div>
      </div>
