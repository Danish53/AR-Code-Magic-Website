  ...
  const uploadData = [
    {
      ...
      description: [
        "Our interface supports 15MB uploads for optimal AR generation, but our team can assist with larger files. Our 3D model review ensures the best enhanced AR renderings.",
        "We can support several 3D file formats on our interface such as .ZIP, .GLTF, .GLB, .X3D, .USDZ, .OBJ, .PLY, .FBX, .STL. ",
        "There are also various other formats supported by our AR Code through our dedicated staff including .JT, .DAE, .BREP, .ABC, .3DM, .IFC, .IGES, .STEP.",
      ],
      link: "/user/register",
  ...
  return (
    <div className="container pt-5">
      ...
      <h2 className="fw-bold text-center text-capitalize text-primary-color mb-4">
        Simplified uploading 3D models
      </h2>

      {/* Description Text */}
      <center>
        <span className="web-font-size">
          Our full uploading interface and various support for 3D file formats will unlock your complete potential
          in 3D models.
        </span>
      </center>
