...
function ServicesFAQ() {
  ...
  const questions = [
    {
      question: "What is the AR Code Magic Object Capture app? ",
      answer:
        "A 3D scanning application for iPhone Pro and iPad Pro that makes it simple to capture objects in 3D and generate AR QR Codes.",
    },
    {
      question: "How does it revolutionize 3D object capture? ",
      answer:
        "By using LiDAR capabilities attached to photogrammetry technology, the AR Code Magic Object Capture app makes it pretty easy to create detailed 3D models without requiring any technical skills. ",
    },
    {
      question: "How can I make a 3D model?",
      answer:
        "Just circle what you want to capture, and then let the app guide you to take photos from all sides of it, including the bottom, to create a really life-like 3D model.  ",
    },
    {
      question: "Is AR Code Magic Object Capture free? ",
      answer:
        "Yes, AR Code Magic Object Capture is free to download and use, but generating an AR QR Code that stays online requires a premium account. ",
    },
  ];
    ...
    <div className="bg-primary-light">
      <div className="container py-5">
        ...
        <p className="text-center text-white web-font-size mb-5">
          Let's dive into our FAQ page for everything you need to know about the AR Code Magic Object Capture app,
          from ground-breaking technology to easy model creation.
        </p>
