    ...
    <section className=" heroServices">
      ...
      <div className="container my-5">
        ...
        <div className="text-center mb-4">
          ...
          Capture objects in 3D instantly with AR Code Magic Magic Object Capture and generate AR QR Codes effortlessly.
         </p>
        </div>
        ...
        <div className="row promo d-flex align-items-center justify-content-center gap-5">
          ...
          <div className="col-md-5 text-center z-1">
            ...
            <br />
            <h2 className="font-weight-bold fw-bold"> This app is available on iPhone Pro and iPad Pro </h2>
            <p className="maindescription text-center web-font-size">
            Explore the magic of 3D models with our AR Code Magic Object Capture. You can transform everything from
            crockery to sculptures into immersive 3D models. Experience the captivating transformation of objects. 
            </p>

            <Link
              to="/user/register"
              className="btn btn-success btn-custom btn-lg mt-3 rounded-pill">
              Start Scanning In 3D
            </Link>
          </div>
        </div>
      </div>
