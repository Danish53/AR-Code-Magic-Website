...
function ServicesFAQ() {
  ...
  const questions = [
    {
      question: "How Can I Try AR Videos? ",
      answer:
        "you can watch AR Videos on any smartphone whether it's Android or iOS by scanning the AR QR Code or by clicking on the URL link to the experience. No app is required for the AR Video display. ",
    },
    {
      question: "How do I make my own AR Video? ",
      answer:
        "You can upload your video to AR Code Magic using your STANDARD or PRO account and your AR code is ready within a few minutes. You can share your generated AR Code to engage viewer experiences. ",
    },
    {
      question: "What are the video file requirements? ",
      answer:
        "use.mp4 or.mov files under 100MB for best performance to ensure fast loading times and high-quality rendering. ",
    },
    {
      question: "Can I cancel my subscription at any time?",
      answer:
        "Yes, you have the right to cancel your subscription at any time. If you do so, we will make sure your subscription is canceled right before your next billing cycle so you can enjoy premium features until the end of your current subscription term. ",
    },
  ];
  ...
  return (
    <div className="bg-primary-light">
      <div className="container py-5">
        ...
        AR Videos offer fresh augmented reality experiences without the need to download extra apps. Here are
