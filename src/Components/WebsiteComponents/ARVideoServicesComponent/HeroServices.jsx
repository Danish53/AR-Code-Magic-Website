    ...
    <section className=" heroServices">
      ...
      <div className="container my-5">
        ...
        <div className="text-center mb-4">
          ...
          Experience our AR Video feature, seamlessly merging video content with real-world environments via AR QR Codes.
          </p>
        </div>
        ...
        <div className="row promo d-flex align-items-center justify-content-center gap-5">
          ...
          <div className="col-md-5 text-center z-1">
            ...
            <p className="maindescription text-center web-font-size">
              Convert your videos into an AR experience with a few easy steps that can be easily accessed on
              smartphones or through AR headsets.
            </p>
