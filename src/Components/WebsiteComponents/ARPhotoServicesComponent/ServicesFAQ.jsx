...
function ServicesFAQ() {
  ...
  const questions = [
    {
      question: "What are 3D AR photos? ",
      answer:
        "They are photographs translated into three-dimensional pictures to be viewed in AR, offering an interactive experience for viewing. ",
    },
    {
      question: "How can I create them using AR Code Magic?",
      answer:
        "Use the AR Frame iOS app for mobile creation or the AR Code web interface for online creation, which steps you through capturing, generating 3D models, and sharing with an AR QR Code. ",
    },
    {
      question: "Can I share my 3D AR photos?",
      answer:
        "Yes, with an AR QR Code produced by AR Code, you can share your 3D AR photos for others to look at in augmented reality across different devices without any application. ",
    },
    {
      question: "Can I cancel my AR Code Magic subscription anytime?",
      answer:
        "Yes, you are free to cancel at any time. We will have the cancellation processed before your following billing cycle so that you can utilize premium features until your subscription is over. ",
    },
  ];
    ...
    <div className="bg-primary-light">
      <div className="container py-5">
        ...
        <p className="text-center text-white web-font-size mb-5">
          Here are some of the most commonly asked questions about our AR Photo feature.
        </p>
