      ...
      <div className="container my-5">
        ...
        <div className="text-center mb-4">
          <p className="font-weight-bold text-white" style={{ fontSize: "28px" }}>
            AR Photo has two disruptive interfaces that turn your photos into immersive 3D Augmented Reality
            experiences.
          </p>
        </div>
        ...
        <div className="row promo d-flex align-items-center justify-content-center gap-5">
          ...
          <div className="col-md-5 text-center z-1">
            ...
            <br />
            <h2 className="font-weight-bold fw-bold">Photo/Image to AR.</h2>
            <p className="maindescription text-center web-font-size">
              Instantly start creating your own 3D AR Photos with AR Code. You can use our AR Frame iOS app or the
              AR Code Magic web interface, your 3D model is just a few clicks away.
            </p>
